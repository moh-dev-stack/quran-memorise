...
describe("TranslationToArabicTransMode", () => {
  ...
  it("should render translation", () => {
    ...
    expect(screen.getByText(/By the morning brightness/i)).toBeInTheDocument();
  });

  it("should show Arabic and transliteration options", () => {
    render(
      <TranslationToArabicTransMode
        question={mockQuestion}
        allQuestions={mockAllQuestions}
