...
import ArabicToTransliterationMode from "@/components/game-modes/ArabicToTransliterationMode";
...
describe("ArabicToTransliterationMode", () => {
  ...
  it("should render Arabic verse", () => {
    render(
      <ArabicToTransliterationMode
  ...
  it("should show transliteration options", () => {
    render(
      <ArabicToTransliterationMode
        question={mockQuestion}
        allQuestions={mockAllQuestions}
    ...
    expect(screen.getByText(/Choose the correct transliteration/i)).toBeInTheDocument();
  });
  ...
  it("should allow selecting an option", async () => {
    ...
    const optionButtons = buttons.filter(
      (btn) => btn.textContent && btn.textContent.includes("Wa")
    );
